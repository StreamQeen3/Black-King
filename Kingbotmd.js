...
module.exports = KingmdWH = async (KingmdWH, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            KingmdWH.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `𝐁𝐥𝐚𝐜𝐤-𝐊𝐢𝐧𝐠`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./GojoMedia/logo.jpeg`),"sourceUrl": "https://i.ibb.co/NTZzzmj/photo-2022-07-06-09-33-03.jpg"}}}, { quoted: m})
        }
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
                KingmdWH.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/NTZzzmj/photo-2022-07-06-09-33-03.jpg' }, caption: `*Hi Bro ${m.pushName}*\ *Follow my github* https://www.github.com/SACHIBOT\n` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
