...
module.exports = KingmdWH = async (KingmdWH, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            KingmdWH.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `𝐁𝐥𝐚𝐜𝐤-𝐊𝐢𝐧𝐠`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./GojoMedia/logo.jpeg`),"sourceUrl": "https://raw.githubusercontent.com/SACHIBOT/Black-King/master/GojoMedia/logo.jpeg"}}}, { quoted: m})
        }
...
break
                    case 'bug': case 'report': {
                    	...
                    	KingmdWH.sendMessage(`94725881990@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
❤️ ʙᴏᴛ ɴᴀᴍᴇ - Black-King

❤️ ᴄʀᴇᴀᴛᴏʀ ɴᴀᴍᴇ - SACHIBOT

❤️ ɢʀᴀᴘʜɪᴄ ᴅᴇꜱɪɢɴ - SACHIBOT

❤️ ᴄᴏɴᴛᴀᴄᴛ - ${global.owner}

❤️ ᴘʟᴀᴛꜰᴏʀᴍ - ${os.platform()}

❤️ ᴛᴏᴛᴀʟ ᴜꜱᴇʀꜱ - ${Object.keys(global.db.data.users).length}
`
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: '© 𝘽𝙡𝙖𝙘𝙠-𝙆𝙞𝙣𝙜',
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: '❤️ YOUTUBE ❤️',
                                    url: `${myweb}`
                                }
                            }, {
                            	urlButton: {
                ...
                KingmdWH.relayMessage(m.chat, template.message, { messageId: template.key.id })
                    ...
                    break
                     case 'bot':{
                           	timestampe = speed();
latensie = speed() - timestampe
 anu = `🍒 ʜɪ ɪᴍ ᴏɴʟɪɴᴇ ɴᴏᴡ 🎉

❄️ ᴏᴡɴᴇʀ - SACHIBOT 

❄️ ʙᴏᴛ ɴᴀᴍᴇ - 𝐁𝐥𝐚𝐜𝐤-𝐊𝐢𝐧𝐠 
...
latensie = speed() - timestampe
                anu = `  
       🍒 ᴛʜɪꜱ ɪꜱ *Black-King* ᴄᴏᴍᴍᴀɴᴅ ʟɪꜱᴛ 🍒
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
                KingmdWH.sendMessage(m.chat, { image: { url: 'https://raw.githubusercontent.com/SACHIBOT/Black-King/master/GojoMedia/logo.jpeg' }, caption: `*Hi Bro ${m.pushName}*\ *Follow my github* https://www.github.com/SACHIBOT\n` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`GitHub : https://github.com/SACHIBOT\n Dont Forget To Give Star\n\nYouTube : ${myweb}\n`)
            }
            break
case 'allmenu': {
  	anu = `
