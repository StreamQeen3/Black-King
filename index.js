...
async function startKingmdWH() {
    ...
    // Get Profile Picture Group
       ...
       KingmdWH.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\nThe Group Has Been Closed By Admin, Now Only Admin Can Send Messages !`, `© 𝘽𝙡𝙖𝙘𝙠-𝙆𝙞𝙣𝙜`, wm_fatih, [])
       } else if(pea[0].announce == false) {
       KingmdWH.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\nThe Group Has Been Opened By Admin, Now Participants Can Send Messages !`, `© 𝘽𝙡𝙖𝙘𝙠-𝙆𝙞𝙣𝙜 `, wm_fatih, [])
       } else if (pea[0].restrict == true) {
       KingmdWH.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\nGroup Info Has Been Restricted, Now Only Admin Can Edit Group Info !`, `© 𝘽𝙡𝙖𝙘𝙠-𝙆𝙞𝙣𝙜`, wm_fatih, [])
       } else if (pea[0].restrict == false) {
       KingmdWH.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\nGroup Info Has Been Opened, Now Participants Can Edit Group Info !`, `© 𝘽𝙡𝙖𝙘𝙠-𝙆𝙞𝙣𝙜`, wm_fatih, [])
       } else {
       KingmdWH.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\nGroup Subject Has Been Changed To *${pea[0].subject}*`, `© 𝘽𝙡𝙖𝙘𝙠-𝙆𝙞𝙣𝙜`, wm_fatih, [])
     }
    })
...
Kon = await getBuffer(`https://hardianto.xyz/api/welcome3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://telegra.ph/file/2d2e8a768415eb8c36a1b.jpg&namegb=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}`)

Tol = await getBuffer(`https://hardianto.xyz/api/goodbye3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://telegra.ph/file/2d2e8a768415eb8c36a1b.jpg&namegb=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}`)
                if (anu.action == 'add') {
